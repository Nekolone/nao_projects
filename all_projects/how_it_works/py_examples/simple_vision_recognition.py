...
"""
Перезапустить НАО и прописать это в его консоли через ssh
...
Далее трансляция будет доступна с хорошим FPS 
tcp://NAO_IP:3001
tcp://192.168.252.247:3001
...
Более простой способ это просто получать картинку с его камеры, но тогда будет FPS будет ниже, как и качество
...
выбрать что-то одно и скопировать ниже
