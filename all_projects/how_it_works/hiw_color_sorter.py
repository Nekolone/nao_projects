...
"""
Класс для описания цвета, состоящий из его имени и двух границ этого цвета в HSV диапазоне
"""
...
class PictureColorDetector:
    ...
    def get_color(self):
        ''''''
        """
        Создавя экземпляр класса мы подключаемся к камере, далее вызывая функцию get_color(), мы получаем цвет самого большого
        объекта.
        """
    ...
    def _pixel_color(self, pixel):
        ''''''
        """
        Возвращает цвет центрального пикселя.
        """
        for color in self.colors:
...
def start_sorting():
    ...
    """
    Создание цветов и передача из в класс распознавания цвета.
    """
    ...
    """
    создает ивенты
    При нажатии передней кнопки головы сжимает руку, распознает цвет и несет его в коробке с таким же цветом
    """
...
"""
Возвращение робота в стартовую позацию
"""
...
"""
Поиск коробки подходящего цвета
"""
...
"""
Поворачивает руку и отпускает предмет в ней
"""
